...
_, _, soundscape_data, _ = load_EGCI(sample=num_samples, region="HSN", dataset_sub="test_5s")

experiment_results = {}
ads = birdset_extactor(region="HSN")
...
for parameters in experiment_parameters:
    ...
    trainer.train()
    experiment_results[parameters["run_name"]] = trainer.evaluate(eval_dataset=ads["test"], metric_key_prefix="Soundscape")
    ...
    _, _, aug_focal_data, focal_samples = load_EGCI(
        ...
        sample=focal_samples, region="HSN", dataset_sub="train")
    ...
    experiment_results[parameters["run_name"]]["data"]  = {
